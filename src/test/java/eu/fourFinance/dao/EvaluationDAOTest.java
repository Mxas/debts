...
public class EvaluationDAOTest extends BaseTest {
	...
	public void testCountGivenLoan() {
		String ip = "1.1.1.1";
		Date date = new Date();
		Evaluation evaluation = evaluationDAO.createEvaluation(subject, date,
				1000d, 5, 1d, ip, 0d);

		debtsDAO.createDebt(pe(evaluation));
		debtsDAO.createDebt(pe(evaluationDAO.createEvaluation(subject, date,
				2000d, 5, 1d, ip, 0d)));
	...
	private Evaluation pe(Evaluation evaluation) {
