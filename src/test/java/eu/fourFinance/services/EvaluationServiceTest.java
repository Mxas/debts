...
public class EvaluationServiceTest extends BaseTest {
    ...
    public void testSimpleEvaluation() {
        ...
        Evaluation evaluation = evaluationDAO.createEvaluation(subject, new Date(), 2000d, 5, 1d, "a", 0d);
    ...
    public void testLowLoanEvaluation() {
        ...
        Evaluation evaluation = evaluationDAO.createEvaluation(subject, new Date(), 20d, 5, 1d, "a", 0d);
    ...
    public void testTooBigLoanEvaluation() {
        ...
        Evaluation evaluation = evaluationDAO.createEvaluation(subject, new Date(), 200000d, 5, 1d, "a", 0d);
    ...
    public void testNightWitMaxLoanEvaluation() {
        ...
        for (int hour = EvaluationService.UNACCEPTABLE_HOURS_FROM; hour <= EvaluationService.UNACCEPTABLE_HOURS_FROM; hour++) {
            ...
            Evaluation evaluation = evaluationDAO.createEvaluation(subject, c.getTime(), EvaluationService.MAX_LOAN, 5, 1d, "a", 0d);
    ...
    public void testMaxApplicationPerDay() {
        ...
        for (int i = 0; i <= EvaluationService.MAX_APPLICATIONS_PER_DAY; i++)
            debtsDAO.createDebt(evaluationDAO.createEvaluation(subject, new Date(), 1000d, 5, 1d, ip, 0d));

        Evaluation evaluation = evaluationDAO.createEvaluation(subject, new Date(), 2000d, 5, 1d, ip, 0d);
